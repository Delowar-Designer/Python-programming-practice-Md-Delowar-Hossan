"""
User Guide: Please, use green cologreen materials for being invisible.
...
class InvisibleCloak:
    ...
    def get_color_mask(self, hsv):
        ...
        lower_mask = cv2.inRange(hsv, lower_green, upper_green)

        lower_green = np.array([170, 20, 70])
        upper_green = np.array([180, 255, 255])
        upper_mask = cv2.inRange(hsv, lower_green, upper_green)
