# Program to display factorial values using iteration
# Programm of custom iterator which prints the factorial of numberrs till the limit
# numbers is reached.
class factorila:
    # constructor
